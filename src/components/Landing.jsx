            ...
            <div className="outline-2px min-w-screen px-24">
                ...
                <div>
                    <div className="flex-col">
                        <Experience title="Software Engineer Intern" description="Delivery Insights & Optimization" company="World Wide Technology" link="https://www.wwt.com" time="June 2026 — Present" image="./wwt.svg" imagealt="World Wide Technology logo"></Experience>

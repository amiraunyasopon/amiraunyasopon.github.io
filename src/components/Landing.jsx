            ...
            <div className="outline-2px min-w-screen px-24">
                ...
                <div>
                    <div className="flex-col">
                        <Experience title="Software Engineer Intern" description="Delivery Insights & Optimization" company="World Wide Technology" link="https://www.wwt.com" time="June 2026 — August 2026" image="./wwt.svg" imagealt="World Wide Technology logo"></Experience>
                        <Experience title="Software Engineer Intern" description="Cloud & Frontend" company="Opal" link="https://www.opal.community" time="December 2025 — May 2026" image="./opal.svg" imagealt="Opal logo" />

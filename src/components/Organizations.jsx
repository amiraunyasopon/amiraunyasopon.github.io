            ...
            <div className="outline-2px min-w-screen px-24">
                ...
                <div>
                    <div className="flex-col">
                        ...
                        <Experience title="Academic and Alumni Affairs Committee Member" description="Coordinating mentorship and learning opportunities" company="ICS Student Council" link="https://studentcouncil.ics.uci.edu" time="Oct 2025 — Present" image="./icssc.svg" imagealt="Informatics and Computer Science Student Council Logo"></Experience>

            ...
            <div className="outline-2px min-w-screen px-24">
                ...
                <div>
                    <div className="flex-col">
                        ...
                        <Experience title="Academic & Alumni Affairs Committee Member" description="Coordinating mentorship & learning opportunities" company="ICS Student Council" link="https://studentcouncil.ics.uci.edu" time="Oct 2025 — Present" image="./icssc.svg" imagealt="Informatics and Computer Science Student Council Logo"></Experience>
                        <Experience title="Ignite Fellow" description="AI-driven development & leadership" company="AI4ALL" link="https://ai-4-all.org" time="May 2026 — Oct 2026" image="./ai4all.svg" imagealt="AI 4 ALL Logo"></Experience>
